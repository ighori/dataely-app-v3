...
export default class FileInfo extends Vue {
  ...
  public retrieveAllFileInfos(): void {
  ...
  public prepareRemove(instance: IFileInfo): void {
  ...
  public removeFileInfo(): void {
    this.fileInfoService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A FileInfo is deleted with identifier ' + this.removeId;

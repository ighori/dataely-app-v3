...
export default class BusinessUnit extends Vue {
  ...
  public retrieveAllBusinessUnits(): void {
  ...
  public prepareRemove(instance: IBusinessUnit): void {
  ...
  public removeBusinessUnit(): void {
    this.businessUnitService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A BusinessUnit is deleted with identifier ' + this.removeId;

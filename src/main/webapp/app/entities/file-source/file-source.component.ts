...
export default class FileSource extends Vue {
  ...
  public retrieveAllFileSources(): void {
  ...
  public prepareRemove(instance: IFileSource): void {
  ...
  public removeFileSource(): void {
    this.fileSourceService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A FileSource is deleted with identifier ' + this.removeId;

...
export default class Environment extends Vue {
  ...
  public retrieveAllEnvironments(): void {
  ...
  public prepareRemove(instance: IEnvironment): void {
  ...
  public removeEnvironment(): void {
    this.environmentService()
      ...
      .then(() => {
        const message = 'A Environment is deleted with identifier ' + this.removeId;

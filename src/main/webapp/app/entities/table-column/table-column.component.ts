...
export default class TableColumn extends Vue {
  ...
  public retrieveAllTableColumns(): void {
  ...
  public prepareRemove(instance: ITableColumn): void {
  ...
  public removeTableColumn(): void {
    this.tableColumnService()
      ...
      .then(() => {
        const message = 'A TableColumn is deleted with identifier ' + this.removeId;

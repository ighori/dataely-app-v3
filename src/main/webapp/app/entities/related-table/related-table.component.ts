...
export default class RelatedTable extends Vue {
  ...
  public retrieveAllRelatedTables(): void {
  ...
  public prepareRemove(instance: IRelatedTable): void {
  ...
  public removeRelatedTable(): void {
    this.relatedTableService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A RelatedTable is deleted with identifier ' + this.removeId;

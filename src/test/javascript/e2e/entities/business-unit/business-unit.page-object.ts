...
export default class BusinessUnitComponentsPage extends AlertPage {
...
export class BusinessUnitDeleteDialog {
  ...
  title: ElementFinder = element(by.id('dataelyAppV3App.businessUnit.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-businessUnit'));
}

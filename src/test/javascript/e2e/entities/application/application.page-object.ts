...
export default class ApplicationComponentsPage extends AlertPage {
...
export class ApplicationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('dataelyAppV3App.application.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-application'));
}

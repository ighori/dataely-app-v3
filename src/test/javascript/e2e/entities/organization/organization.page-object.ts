...
export default class OrganizationComponentsPage extends AlertPage {
...
export class OrganizationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('dataelyAppV3App.organization.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-organization'));
}

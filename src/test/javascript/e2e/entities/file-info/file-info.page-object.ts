...
export default class FileInfoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('file-info-heading'));
...
export class FileInfoDeleteDialog {
  ...
  title: ElementFinder = element(by.id('dataelyAppV3App.fileInfo.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fileInfo'));
}

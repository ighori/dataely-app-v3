...
export default class FileFieldComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('file-field-heading'));
...
export class FileFieldDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('dataelyAppV3App.fileField.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fileField'));
}

...
export default class DataSourceComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('data-source-heading'));
...
export class DataSourceDeleteDialog {
  ...
  title: ElementFinder = element(by.id('dataelyAppV3App.dataSource.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-dataSource'));
}

...
import FileInfoComponent from '@/entities/file-info/file-info.vue';
import FileInfoClass from '@/entities/file-info/file-info.component';
...
describe('Component Tests', () => {
  describe('FileInfo Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<FileInfoClass>(FileInfoComponent, {
        store,
        localVue,
    ...
    it('Should call load all on init', async () => {
      // GIVEN
      fileInfoServiceStub.retrieve.resolves({ headers: {}, data: [{ id: 123 }] });

      // WHEN
      comp.retrieveAllFileInfos();
      await comp.$nextTick();

      // THEN
      expect(fileInfoServiceStub.retrieve.called).toBeTruthy();
      expect(comp.fileInfos[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(fileInfoServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(fileInfoServiceStub.retrieve.callCount).toEqual(3);

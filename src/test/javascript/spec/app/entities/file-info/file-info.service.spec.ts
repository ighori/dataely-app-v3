...
describe('Service Tests', () => {
  describe('FileInfo Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a FileInfo', async () => {
        const returnedFromService = Object.assign(
          {
            id: 123,
            creationDate: dayjs(currentDate).format(DATE_TIME_FORMAT),
      ...
      it('should not create a FileInfo', async () => {
      ...
      it('should update a FileInfo', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            detail: 'BBBBBB',
      ...
      it('should not update a FileInfo', async () => {
      ...
      it('should partial update a FileInfo', async () => {
      ...
      it('should not partial update a FileInfo', async () => {
      ...
      it('should return a list of FileInfo', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            detail: 'BBBBBB',
      ...
      it('should not return a list of FileInfo', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a FileInfo', async () => {
      ...
      it('should not delete a FileInfo', async () => {

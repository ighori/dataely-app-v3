...
import com.dataely.app.service.mapper.OrganizationMapper;
...
class OrganizationResourceIT {
    ...
    void createOrganization() throws Exception {
        ...
        assertThat(testOrganization.getDetail()).isEqualTo(DEFAULT_DETAIL);
        assertThat(testOrganization.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testOrganization.getLastUpdated()).isEqualTo(DEFAULT_LAST_UPDATED);
    }
    ...
    void putNewOrganization() throws Exception {
        ...
        updatedOrganization.name(UPDATED_NAME).detail(UPDATED_DETAIL).creationDate(UPDATED_CREATION_DATE).lastUpdated(UPDATED_LAST_UPDATED);
        ...
        assertThat(testOrganization.getDetail()).isEqualTo(UPDATED_DETAIL);
        assertThat(testOrganization.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testOrganization.getLastUpdated()).isEqualTo(UPDATED_LAST_UPDATED);
    }
    ...
    void partialUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.name(UPDATED_NAME).lastUpdated(UPDATED_LAST_UPDATED);
